...
title: 'updates'
description: 'whatever happened idk,'
---

## Updates:
|Date|Content|
|-|-|
|14/9/25|added some buttons and stuff i think|
|10/9/25|one hundred ivys|
|22/8/25|i may or may not have forgot this updates page exists oops, grabbed css thing from [this](https://cyrneko.eu/css-tricks.html) because it looked cool, thanks alexia|
|4/7/25|changed how buttons work, and added [strongsand's](https://proot.party) button|
|27/5/25|added [emi's](https://garnix.dev) button|
|25/6/25|added [lily's](https://sapphicyearn.ing) button|
|12/6/25|added enjarai's button!!|
|28/5/25|some changes to things|
|23/5/25|css stuff, and just more changes really idk|
|21/5/25|general changes i wanted to do|
...
|16/12/24|the "blue hair and pronouns" update (added a link to pronouns.cc), autumn's button|
